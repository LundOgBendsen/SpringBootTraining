package dk.lungogbendsen.springbootex19persistence.education;

import dk.lungogbendsen.springbootex19persistence.education.model.*;
import dk.lungogbendsen.springbootex19persistence.education.repository.CourseRepository;
import dk.lungogbendsen.springbootex19persistence.education.repository.QBExampleRepository;
import dk.lungogbendsen.springbootex19persistence.education.repository.StudentRepository;
import dk.lungogbendsen.springbootex19persistence.education.repository.TeacherRepository;
...
//@ContextConfiguration(classes = {SpringbootEx19PersistenceApplication.class})
...
public class EducationTest {
    ...
    final Course art = Course.builder().subject("art").points(10).teacher(johnson).students(List.of(josh, jane, tom)).build();
    final Course philosophy = Course.builder().subject("philosophy").points(10).teacher(smith).students(List.of(tom, anna, jane)).build();
    final Course math = Course.builder().subject("math").points(10).teacher(kayne).students(List.of(josh, tom, anna)).build();
