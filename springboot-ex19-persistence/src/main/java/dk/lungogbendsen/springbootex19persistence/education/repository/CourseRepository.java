...
import dk.lungogbendsen.springbootex19persistence.education.model.Course;
import dk.lungogbendsen.springbootex19persistence.education.model.Student;
import dk.lungogbendsen.springbootex19persistence.education.model.StudentCourseCount;
...
public interface CourseRepository extends JpaRepository<Course, Long> {
    ...
    @Query("select new dk.lungogbendsen.springbootex19persistence.education.model.StudentCourseCount(s.name, count(s.name)) from Course c inner join c.students s group by s.id")
